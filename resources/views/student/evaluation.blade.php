...
<x-layouts::app :title="__('Evaluation')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-6">
        <section class="rounded-3xl border border-zinc-200 bg-zinc-50 px-6 py-8 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="mt-3 flex flex-wrap items-center gap-3">
                <h1 class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">{{ __('Evaluation') }}</h1>
            ...
            <p class="mt-3 text-sm leading-6 text-zinc-600 dark:text-zinc-300">{{ __('Summarize earned units and grades by the classifications defined in the active evaluation template.') }}</p>
        </section>
